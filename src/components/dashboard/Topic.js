...
const Topic = ({ topicHeading, topicData, getTopicData, isUser = false, handleEditModalShow }) => {
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="danger" onClick={(e) => { deleteTopic(topicName, getTopicData); handleClose() }}>
                        Delete
                    </Button>
                </Modal.Footer>
            </Modal>
